...
let EstadisticasComponent = class EstadisticasComponent {
    constructor(fb, estadisticasService, router) {
        this.fb = fb;
    ...
    consultarConsumoClientes() {
        let consulta = Object.assign({}, this.formGroup1.value);
    ...
    consultarProductosTop() {
        let consulta = Object.assign({}, this.formGroup2.value);
...
EstadisticasComponent.ctorParameters = () => [
...
EstadisticasService.ctorParameters = () => [
...
let FacturaComponent = class FacturaComponent {
    constructor(fb, facturasService, router) {
        this.fb = fb;
    ...
    agregarDetalle() {
        let detalleArr = this.formGroup.get('detalles');
    ...
    removerDetalle(index) {
        let detalles = this.formGroup.get('detalles');
        detalles.removeAt(index);
    }
    save() {
        let factura = Object.assign({}, this.formGroup.value);
...
let MeserosDeleteComponent = class MeserosDeleteComponent {
    constructor(meserosService, router, activatedRoute) {
...
MeserosDeleteComponent.ctorParameters = () => [
...
let MeserosFormComponent = class MeserosFormComponent {
    constructor(fb, meserosService, router, activatedRoute) {
        this.fb = fb;
        this.meserosService = meserosService;
        this.router = router;
        this.activatedRoute = activatedRoute;
    ...
    save() {
        let mesero = Object.assign({}, this.formGroup.value);
...
MeserosFormComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] },
...
let MeserosComponent = class MeserosComponent {
    constructor(meserosService) {
        this.meserosService = meserosService;
    }
    ngOnInit() {
...
MeserosComponent.ctorParameters = () => [
    { type: _meseros_service__WEBPACK_IMPORTED_MODULE_1__["MeserosService"] }
];
